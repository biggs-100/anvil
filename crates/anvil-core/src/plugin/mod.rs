...
pub trait Plugin: Send + Sync {
    ...
    /// API version of this plugin. Defaults to `ANVIL_PLUGIN_API_VERSION`.
    fn api_version(&self) -> &str {
        ANVIL_PLUGIN_API_VERSION
    }
...
pub enum PluginError {
    ...
    /// The plugin's `api_version` does not match `ANVIL_PLUGIN_API_VERSION`.
    ApiVersionMismatch {
        plugin: String,
        expected: String,
        actual: String,
